use crate::data::application_data::{ApplicationData, PeakLabel};
...
impl TextRenderer {
    ...
    pub fn prepare_peak_labels(peaks: &Vec<PeakInstance>) -> Vec<PeakLabel> {
        ...
        let text_areas = laid_out_labels
            ...
            .map(
                |LabelLayout {
                    ...
                    buffer: &data.peak_labels.get(&location).unwrap()[id.0 as usize].buffer,
